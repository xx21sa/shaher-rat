# DiscordRAT 2.0 - Shaher dev Edition
Discord Remote Administration Tool fully written in c# with interactive button interface.

This is a RAT controlled over Discord with over 40 post exploitation modules and modern button-based UI.

The output file size also around ~75kb!

## **Disclaimer:**

This tool is for educational use only, Shaher dev will not be held responsible for any misuse of this tool.

## **Credits**
Modified and enhanced by Shaher dev with interactive button interface.
...
## **Setup Guide:**
Build the project using the provided build configuration.
